...
export const FilterModal = ({ isOpen, onClose, onFiltereSelect, rangeValue, setRangeValue, MIN_BOUND, MAX_BOUND, }) => {

    const handleSliderChange = (value) => {
        setRangeValue(value);
    }
    const handleApplyAmountFilter = () => {
        onFiltereSelect({ type: 'amount', min: rangeValue[0], max: rangeValue[1] })
    }
